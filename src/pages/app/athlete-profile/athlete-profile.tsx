            ...
            <div className="flex flex-col gap-4 overflow-hidden">
              ...
              <div className="flex flex-col bg-slate-800 border border-slate-700 rounded p-6 relative gap-6">
                <div className="flex items-start gap-4">
                  <div className="size-14 flex items-center border-slate-700 justify-center border rounded-full flex-shrink-0">
                    <ClipboardPenLine className="size-7 text-slate-400" />
                  </div>
                  <div className="flex flex-col gap-2">
                    ...
                    <h3 className="text-slate-400 text-md">
                      Insira observações sobre os atletas
                    </h3>
                  </div>
                </div>

                <div className="w-full h-[300px] rounded-md flex flex-col border border-slate-700 ">
                  <div>
                    <div className="w-full h-full flex overflow-x-auto rounded-md bg-slate-900 scrollbar scrollbar-custom ">
                      {Object.entries(profissionalDaSaude).map(
                        ([key, value]) => (
                          <div
                            tabIndex={0}
                            key={key}
                            className="w-full h-[45px] border border-slate-700  flex items-center text-center hover:bg-[#334155] cursor-pointer transition-all duration-500 focus:bg-[#334155]"
                          >
                            <span
                              tabIndex={0}
                              className="flex items-center justify-center w-[150px] focus:text-lime-500 h-full text-center hover:text-lime-500 transition-all duration-600"
                            >
                              {value}
                            </span>
                          </div>
                  ...
                  <div className="p-4 h-full bg-slate-900 flex flex-col justify-between gap-4">
                    <textarea
                      className="w-full border border-slate-700 bg-slate-900 h-full resize-none px-6 py-2 text-sm text-slate-400 rounded-md focus:border-slate-500 focus:outline-none"
                      placeholder="Digite uma observação para o atleta..."
                      name=""
                      id=""
                    ></textarea>
                    <Button
